const APP_CACHE='werd-v14';
const RUNTIME_CACHE='werd-runtime-v14';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./notifications.js','./features.js','./reader.js','./listening.js','./prayer.js','./more.js','./search.js','./iman.js','./home.js','./progress.js','./onboarding.js','./manifest.webmanifest','./icon.svg'];
