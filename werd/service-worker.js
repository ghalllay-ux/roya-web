const APP_CACHE='werd-v9';
const RUNTIME_CACHE='werd-runtime-v9';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./notifications.js','./features.js','./reader.js','./listening.js','./prayer.js','./more.js','./manifest.webmanifest','./icon.svg'];
