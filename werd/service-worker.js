const APP_CACHE='werd-v10';
const RUNTIME_CACHE='werd-runtime-v10';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./notifications.js','./features.js','./reader.js','./listening.js','./prayer.js','./more.js','./search.js','./manifest.webmanifest','./icon.svg'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.hostname.includes('alquran.cloud')||url.hostname.includes('islamic.network')||url.hostname.includes('aladhan.com')||url.hostname.includes('raw.githubusercontent.com')||url.hostname.includes('cdn.jsdelivr.net')){
