const APP_CACHE='werd-v11';
const RUNTIME_CACHE='werd-runtime-v11';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./notifications.js','./features.js','./reader.js','./listening.js','./prayer.js','./more.js','./search.js','./iman.js','./manifest.webmanifest','./icon.svg'];
